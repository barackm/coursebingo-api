...
describe 'the sign up process', type: :feature do
  ...
  it 'should not save user username less than 3 characters' do
    user = User.new(first_name: 'Jo', last_name: 'Doe', email: 'john@gmail.com', password: '123456', password_confirmation: '123456')
    expect(user.save).to be(false)
  end

  it 'should save user with all fields' do
    user = User.new(first_name: 'John', last_name: 'Doe', email: 'john@gmail.com', password: '123456', password_confirmation: '123456')
    user.save
