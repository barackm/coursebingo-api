...
describe 'the favourite feature', type: :feature do
  it 'should not add to favourites a course if no user_id is passed' do
    ...
    course = Course.create(name: 'javascript', price: '40', description: 'this is the description of the course',
  ...
  it 'should not add to favourites a course if no course_id is passed' do
    user = User.new(first_name: 'John', last_name: 'Doe', email: 'john@gmail.com', password: '12',
                    password_confirmation: '12')
    Course.create(name: 'javascript', price: '40', description: 'this is the description of the course',
                  author_id: user.id, duration: '2')
  ...
  it 'should add to favourites a course if the course_id and user_id are valid' do
    ...
    expect(favourite.save).to be(true)
  end
end
